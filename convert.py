...
with bz2.open("./mozcdic-ut-skk-jisyo.txt.bz2", "rt", encoding="utf-8") as f:
    data = f.read()
...
Path("./build/jtalkdic-ud-skk-jisyo-ipadic.csv").write_text("\n".join(out), encoding="utf-8")
...
Path("./build/jtalkdic-ud-skk-jisyo-noacc.csv").write_text("\n".join(out), encoding="utf-8")